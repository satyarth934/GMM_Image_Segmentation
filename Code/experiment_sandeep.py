...
# img = Image.open('../Data/Proper_Dataset/green_buoy/green_1.jpg').resize((480,320), Image.ANTIALIAS)
img = cv2.imread("../Data/Proper_Dataset/green_buoy/green_1.jpg")
img = cv2.resize(img, (480, 320))

# pixels = np.asarray(((img.getdata())))
pixels = np.vstack([img[:,:,0].ravel(), img[:,:,1].ravel(), img[:,:,2].ravel()]).T
